...
Esse exemplo mostra por que a comparação entre provedores precisa ir além do nome comercial. Azure é uma implementação de nuvem pública, enquanto computação em nuvem é o modelo mais amplo de provisionamento e operação de recursos de TI sob demanda.
