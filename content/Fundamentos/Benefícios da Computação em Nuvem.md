...
Economias de escala surgem quando uma infraestrutura muito grande dilui custos entre muitos clientes e workloads. Workload significa carga de trabalho: uma aplicação, um banco de dados, um processamento, uma API ou qualquer sistema que consome recursos de tecnologia. Um provedor de nuvem compra hardware em grande volume, opera muitos [[Data Centers|data centers]], padroniza processos, automatiza instalação e manutenção, reutiliza conhecimento operacional e distribui custos de rede, energia, segurança e equipe por uma base ampla de uso.
